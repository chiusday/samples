...
var UserComponent = /** @class */ (function () {
    ...
    UserComponent.prototype.onSubmit = function () {
        ...
        this.loginService.login(this.user).subscribe(function (user) {
            if (user.id == '0') {
                alert("User " + _this.user.name + " not found.");
            }
            else {
                alert("User ID " + user.id + " loaded successfuly.");
            }
            _this.user = user;
            console.log("API call done: " + _this.user.id + " " + _this.user.name + " " + _this.user.password);
        });
    };
...
var LoginService = /** @class */ (function () {
    function LoginService(httpClient) {
        ...
        this.loginUrl = 'http://localhost:60011/samples/login';
    }
    LoginService.prototype.login = function (user) {
        return this.httpClient.post(this.loginUrl, user, httpOptions);
    };
...
module.exports = __webpack_require__(/*! /Users/jon/git/samples/springboot-angular/src/main/ui/src/main.ts */"./src/main.ts");
